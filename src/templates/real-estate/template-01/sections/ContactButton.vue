...
<template>
  <v-btn class="local-contact-button" :color="color" :prepend-icon="icon" :rounded="rounded" :variant="variant" @click="handleClick">
    {{ label || template.cta?.primaryLabel || 'Hubungi Kami' }}
  </v-btn>
</template>
